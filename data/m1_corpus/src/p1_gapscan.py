...
N_RUN = int(os.environ.get("N_RUN", "20000"))
SAMP = 5
AMP = 0.05
SCAN = [float(s) for s in os.environ.get("SCAN", "8,10,12,14").split(",")]
...
json.dump(results, open("/mnt/agents/output/e44_data/p1_gapscan.json", "w"), indent=2)
