...
# -*- coding: utf-8 -*-
"""
E62 — FENÊTRE LONGUE : la cage confinée tient-elle à t=180 ? : la cage ANU sous confinement
[protocole E61-PRESSION-1.0 gelé]
=====================================================================
Harnais officiel de la campagne E61. Protocole gelé dans
e62_protocole.json (haché avant tout calcul — aveugle préservé).
...
def main():
    ...
    t0 = time.time()
    res = {"campagne": "E62", "protocole": "E61-PRESSION-1.0 (gelé)"}
