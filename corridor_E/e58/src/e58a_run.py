...
# -*- coding: utf-8 -*-
"""
E58-A — RÉSEAU IMPRIMÉ (relaxation réparée : sans paroi, paroi enclenchée à l'entrée — amendement gelé) : un réseau ordonné de lignes, écrit directement,
...
def main():
    ...
    res = {"campagne": "E58-A", "protocole": "E58-RESEAU-1.0 (gelé)",
    ...
    for bras, sites in (("A", sites_A), ("B", sites_B)):
        ...
        for step in range(1, PAS_RELAX + 1):
            psi = gp_step(psi, lin, GAMMA, DT, fix=None)  # amendement E58-A
        snaps = {}
        pos, nl, anom, amb = positions_lignes(psi, inside, Xg, Yg, Zg)
        p6 = psi6(pos)
