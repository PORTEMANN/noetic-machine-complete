...
def vitesse_biotsavart(fils, confine=False, kappa=None):
    ...
    if confine:
        ...
        v -= kap * pts / np.maximum(r, 1e-9)
    return v


def rk4(fils, dt, confine=False, kappa=None):
    def f(F):
        return vitesse_biotsavart(F, confine, kappa)
    k1 = f(fils)
