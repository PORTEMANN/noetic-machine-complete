...
# -*- coding: utf-8 -*-
"""
E54-C — LIGNES TRESSÉES SOUS ROTATION, protocole corrigé d'emblée
[E54-C gelé — haché avant tout calcul ; harnais = celui d'E54-A,
byte-identique sauf en-tête et agrégation P0]
=====================================================================
...
def main():
    ...
    res = {"campagne": "E54-C", "amendement": "b495267e…964c1189 (gelé)",
           "runs": {}}
    for graine in SEEDS:
    ...
    # contrôle pré-enregistré : reproduction exacte d'E54-A (déterministe)
    try:
    ...
    res["agregation"] = ag
    out = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                       "..", "data", "e54c_tressage_verdict.json")
    with open(out, "w", encoding="utf-8") as f:
